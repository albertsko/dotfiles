...
- Treat operations involving multiple resources as a single transaction; commit only when every resource is available, and return partial acquisitions after any failure.
