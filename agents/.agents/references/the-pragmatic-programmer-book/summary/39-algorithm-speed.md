...
- Test representative, ordered, random, small, large, and worst-case inputs in a production-like environment.
- Use a profiler to count executed operations when elapsed-time measurements are unreliable.
