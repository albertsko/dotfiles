...
- Treat coworkers' code with the same care you expect for your own: understand its intent, preserve its quality, and improve it respectfully.
- Keep responsibility visible in collectively owned code; use collaborative practices such as pair programming to prevent anonymity from weakening quality.
- Reject project size or shared ownership as excuses for sloppy work; apply the same professional standard to common foundations as to code associated directly with your name.
