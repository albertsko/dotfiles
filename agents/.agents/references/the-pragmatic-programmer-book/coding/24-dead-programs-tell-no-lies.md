...
- Check the results of fallible operations even when failure seems unlikely. Verify file closure, diagnostic writes, network and filesystem operations, and the loaded versions of dependencies.
